...
<center><img src="sstc1.jpg" width="100" height="100">
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact Ankit Ray.
Designed & Developed by Ankit Ray</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @Ankit Ray :: 2021-2022</h5></center> 
  <hr class="new1">
<br>
</body>
</html>