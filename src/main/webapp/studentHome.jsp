...
<center><img src="sstc1.jpg" width="150" height="150">
<img src="apj sir.png" align="right"  width="150" height="150"></center>
    <a href="sstcOneView.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
...
Designed & Developed by Ankit Ray</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Ankit Ray :: 2021-2022</h6></center> 
  <hr class="new1">
</body>
...
{
	response.sendRedirect("errorSstcOneView.html");
}
}
catch(Exception e)
{
